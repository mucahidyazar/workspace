    ...
    return (
      <html lang="en-US">
        <Head>
          ...
          <meta name="application-name" content="next-hackernews" />
          <meta name="apple-mobile-web-app-title" content="next-hackernews" />
          ...
          <link rel="apple-touch-icon" type="image/png" sizes="192x192" href="/static/icons/icon-192x192"></link>
        </Head>
        <body>
          <Main />
          <NextScript />
